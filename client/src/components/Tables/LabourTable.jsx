...
export default function LabourTable({ labours, onDelete }) {
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      <h2 className="text-2xl font-bold mb-6">Labour Records</h2>
                  ...
                  <td className="p-3">
                    <span
                      className={`px-3 py-1 rounded-full text-white text-sm ${
                        labour.status === "Active" ? "bg-green-500" : "bg-red-500"
                      }`}
                    >
                      {labour.status}
                    </span>
